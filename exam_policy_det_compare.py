...
if __name__ == "__main__":
    ...
    test_a = [31,31,31,29,28,20,20,20,20,20]
    for i in range(N): 
        dck, _ = gtr_disturb.find_closest(front_car_traj[i][0], gtr_disturb.d_list)
        dc =  gtr_disturb.d_list[dck]
        a_disturb = gtr_disturb.a_list[test_a[i]]
        ...
        print("action:%.2f, r_cost: %.2f"%(a_disturb, r_cost))
